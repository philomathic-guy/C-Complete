...
<caption><h1>QUIZES</h1></caption>
  ...
  <tr >
    <td id="middle">1</td>
    <td id="data"><a class="titles" href="questions.php?type=dai&name=QUIZ 1: DECLARATIONS AND INITIALISATION">QUIZ 1: DECLARATIONS AND INITIALISATION</a></td>   
    </tr>
  <tr>
    <td id="middle">2</td>
    <td id="data"><a class="titles" href="questions.php?type=arr&name=QUIZ 2: ARRAYS">QUIZ 2: ARRAYS</a></td>   
    </tr>
<tr>
    <td id="middle">3</td>
    <td id="data"><a class="titles" href="questions.php?type=str&name=QUIZ 3: STRINGS">QUIZ 3: STRINGS</a></td>   
    </tr>   
<tr>
    <td id="middle">4</td>
    <td id="data"><a class="titles" href="questions.php?type=fun&name=QUIZ 4: FUNCTIONS">QUIZ 4: FUNCTIONS</a></td>   
    </tr>
<tr>
    <td id="middle">5</td>
    <td id="data"><a class="titles" href="questions.php?type=loop&name=QUIZ 5: STRUCTURES,UNIONS AND ENUMS">QUIZ 5: STRUCTURES,UNIONS AND ENUMS</a></td>    
    </tr>
</tbody>
</table>
<div>
